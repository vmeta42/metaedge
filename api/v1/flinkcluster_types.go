...
const (
	...
	ControlAnnotation = "flinkclusters.daas.tenxcloud.com/user-control"
...
func (r *FlinkCluster) GenServerAccountName() string {
	return fmt.Sprintf("%s-sa", r.Name)
}

func (r *FlinkCluster) GenRoleName() string {
	return fmt.Sprintf("%s-role", r.Name)
}

func (r *FlinkCluster) GenRoleBindingName() string {
	return fmt.Sprintf("%s-rolebinding", r.Name)
}

func (r *FlinkCluster) GetServiceAccountName() string {
	if *r.Spec.ServiceAccountName != "" {
		return *r.Spec.ServiceAccountName
	}
	return r.GenServerAccountName()
}
