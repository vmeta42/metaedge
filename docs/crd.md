...
named `FlinkCluster` for specifying a Flink job cluster ([sample](../config/samples/flinkoperator_v1_flinkjobcluster.yaml))
or Flink session cluster ([sample](../config/samples/flinkoperator_v1_flinksessioncluster.yaml)), depending on
...
following structure. The v1 version of the API definition is implemented [here](../api/v1/flinkcluster_types.go).
